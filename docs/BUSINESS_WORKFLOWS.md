...
T009 实现第 3–4 节的有序调度、投影、暂停、取消与重放；T010 接入真实 gate runner；T011 完成评审与接受；T013/T014 完成代理和人工交接；T016 提供可用 CLI/TUI；T019–T024 完成预览、导出、授权、副作用、成本和生命周期。各阶段只能把已实测能力从“规划”改为“可用”。