...
| AT-22 | BLOCKED | T025 is not implemented: `operator-interaction` Schema/goldens, TUI interaction inbox, structured response, and recovery tests are absent |
...
|---|---|---|
| Core task chain and fail-closed scenarios | BLOCKED | Existing AT-01–AT-14 and AT-16–AT-21 pass; T025–T028/AT-22–AT-24 are not implemented |
...
4. Complete T025/AT-22 TUI operator interaction, T026/T027/AT-23 full AgentRunner execution, and T028/AT-24 reduced-assurance visible black-box candidates; then rerun the tutorial against the final ZIP, bind the support matrix/release notes, and obtain explicit product-owner S1 exit approval. Until then, T018 and S1 remain incomplete.