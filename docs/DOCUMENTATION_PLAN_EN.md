...
| Installation planning | [安装规划](INSTALLATION_PLAN.md) / [Installation](INSTALLATION_PLAN_EN.md) | Current boundary, open distribution design, upgrade/uninstall gates | Artifact/path/signing/support decisions; release owner |
