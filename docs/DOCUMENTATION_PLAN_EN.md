...
| Testing | [验证](TEST_STRATEGY.md) / [Testing](TEST_STRATEGY_EN.md) | 22 AT groups, tiers, platforms, faults, evidence | Requirements/contracts; test maintainer |
...
| Implementation | [计划](DEV_PLAN.md) / [Plan](DEV_PLAN_EN.md) | 25 tasks, dependencies, scope, traceability | Task/stage acceptance; implementation lead |
