...
AT-16–AT-21 are RFC section 19 S1 minimum acceptance; AT-22 is the added AI/operator interaction-loop acceptance. All use deterministic fixtures without paid calls first. S0 T002/T003 freeze records/fixtures only; parse success is not runtime evidence. T018 summarizes all 22 groups. US7–US10 cover trial, delivery, revocation and retirement recovery; local measurements establish value without assumed savings.
