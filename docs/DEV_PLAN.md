...
workspace、state-event、error、adapter-envelope、adapter-receipt 八份 Draft 2020-12 结构 Schema；首批
canonical 向量、单记录状态转换、错误分类/CLI 退出码及文件队列 framing/claim/result/dispatch/takeover
receipt 已冻结，尚待跨事件/跨记录 checker、具体错误目录/主次规则、签名 receipt、其余持久对象及
