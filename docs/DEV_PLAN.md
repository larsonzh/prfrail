...
workspace、state-event、error、adapter-envelope、adapter-receipt、snapshot-manifest 九份 Draft 2020-12
结构 Schema；首批 canonical 向量、单记录状态转换、错误分类/CLI 退出码、文件队列
framing/claim/result/dispatch/takeover receipt 及快照内容/父引用/可移植恢复边界已冻结，尚待跨事件/跨记录
