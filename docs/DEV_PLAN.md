...
review-receipt、promotion-receipt 十二份 Draft 2020-12 结构 Schema；首批 canonical 向量、单记录状态转换、错误分类/CLI 退出码、
文件队列 framing/claim/result/dispatch/takeover receipt、快照边界、评审前证据根及 approve/reject/waive
评审结论和原子 promotion reader contract 已冻结，尚待跨事件/跨记录 checker、具体错误目录/主次规则、handoff/签名 receipt、
