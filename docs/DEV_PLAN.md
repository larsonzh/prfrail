...
workspace、state-event 五份 Draft 2020-12 结构 Schema；单记录状态转换已冻结，尚待 canonical 测试向量、
跨事件 checker、错误码、队列、其余持久对象及 ADR-004。T003 独立 validator/语义 checker 与正反 golden 尚未执行，因此不得标记 T002、AT-01
或 RFC §17.2 完成。
